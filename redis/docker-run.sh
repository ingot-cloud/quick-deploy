...
cp ${currentPath}/ingot-redis.conf /ingot-data/docker/volumes/redis-4.0.10/conf
...
docker run --name redis \
 ...
 -p 6379:6379 \
 -v /ingot-data/docker/volumes/redis-4.0.10/conf/ingot-redis.conf:/etc/redis/redis.conf \
